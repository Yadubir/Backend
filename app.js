...
const mongoUrl = 'mongodb+srv://anshumanpersonnel:AnshumanSingh@cluster0.zpnclkj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
app.post('/reservation', async (req, res) => {
    const {email, duration, from, parkingStand, name, totalAmount, userId } = req.body;
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        res.send({ status: 'ok', data: 'Login successful', user });
    } catch (error) {
        return res.status(500).send(error.message);
    }
});
